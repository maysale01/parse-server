...
function Schema(collection, mongoSchema) {
    ...
    try {
        for (var _iterator = mongoSchema[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var obj = _step.value;
...
function load(collection) {
    return collection.find({}, {}).toArray().then(function (mongoSchema) {
...
Schema.prototype.validateClassName = function (className, freeze) {
    ...
    return this.collection.insert([{ _id: className }]).then(function () {
...
Schema.prototype.setPermissions = function (className, perms) {
    ...
    update = { '$set': update };
    return this.collection.findAndModify(query, {}, update, {}).then(function () {
...
function getObjectType(obj) {
    ...
    if (obj.__type == 'GeoPoint' && obj.latitude != null && obj.longitude != null) {
        return 'geopoint';
    }
    if (obj['$ne']) {
