...
function del(config, auth, className, objectId) {
  ...
  return Promise.resolve().then(function () {
    if (triggers.getTrigger(className, 'beforeDelete') || triggers.getTrigger(className, 'afterDelete') || className == '_Session') {
...
function update(config, auth, className, objectId, restObject) {
  ...
  return Promise.resolve().then(function () {
    if (triggers.getTrigger(className, 'beforeSave') || triggers.getTrigger(className, 'afterSave')) {
